...
function Pagination({ totalPosts, setCurrentPage, currentPage }) {
  const pages = [];
  ...
  return (
    <div className="fixed right-0 bottom-12 mx-auto inline-flex items-center justify-center -space-x-px rounded-md shadow-sm md:right-10 lg:right-20">
      <button
